@extends('../admin/layouts.app',['pageTitle' => 'Add User'])
    ...
    <div class="col-md-9 mt-3 mb-3">
      <div class="card card-default">
        <div class="card-header">
          <h4 class="modal-title ml-3">Add User</h4>
        </div>  
        ...
        @endif
         ...
         {{-- form for registering user --}}
          <form  method="POST" action="/admin/storeuser" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group row">
                  <div class="col-md-12 ">
                      <input id="avatar" type="file" class="form-control" name="image" required>
                  </div>
              </div>
              </div>
              <div class="form-group">
